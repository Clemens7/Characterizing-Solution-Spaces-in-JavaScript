...
async function main(){
    ...
    frame.addEventListener("keyup", event => {
        slider_frame.value = frame.value;
        frameWidth = frame.value;
        frameWidthR = frame.value;
    ...
    document.getElementById("mat-color-div").addEventListener("change", event => {
        redoRender(sizes, art_container, preview_image);
    });
    document.getElementById("frame-style-div").addEventListener("change", event => {
        redoRender(sizes, art_container, preview_image);
    });
    document.getElementById("segmented-div").addEventListener("change", event => {
        redoRender(sizes, art_container, preview_image);
    });
    button.onclick = ;
...
function setTotalSize(sizes) {
    ...
    if (document.getElementById("print-size-s").checked) {
        totalSizeX += parseFloat(sizes.S[0]);
        totalSizeY += parseFloat(sizes.S[1]);
        ...
        totalSizeX += parseFloat(sizes.L[0]);
        totalSizeY += parseFloat(sizes.L[1]);
    }
...
function redoRender(sizes, art_container, preview_image) {
    ...
    if (document.getElementById("mat-color-ivory").checked) {
        matColor = "ivory";
    } else if (document.getElementById("mat-color-mint").checked)  else if (document.getElementById("mat-color-wine").checked)  else if (document.getElementById("mat-color-indigo").checked) {
        matColor = "indigo";
