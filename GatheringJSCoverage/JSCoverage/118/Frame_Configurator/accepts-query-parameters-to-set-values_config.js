...
function translateUrlParamsToFrom() {
    ...
    if (myParam != null){
        if (printSizes_values.includes(myParam.toUpperCase())){
            let sizes = document.getElementsByName("printSize");
            for (let size of sizes){
                size.checked = size.id === `print-size-${myParam.toLowerCase()}`;
            }
        }
    }
    ...
    if (myParam != null){
        if (frame_styles.includes(myParam.toLowerCase())){
            let styles = document.getElementsByName("frameStyle");
            for (let style of styles){
                style.checked = style.id === `frame-style-${myParam.toLowerCase()}`;
            }
        }
    }
    ...
    if (myParam != null){
        if (mat_Colors.includes(myParam.toLowerCase())){
            let styles = document.getElementsByName("matColor");
            for (let style of styles){
                style.checked = style.id === `mat-color-${myParam.toLowerCase()}`;
            }
        }
    }
    ...
    if (myParam_X !== null){
        myParam = parseFloat(myParam_X) / 10;
        if (myParam > max_frame) 

        if (myParam < min_frame) 
        const frameSize_input = document.getElementById("frameWidth");
        const frameSize_slider = document.getElementById("frameWidthR");

        frameSize_input.value = (Math.round(myParam * 10) / 10);
    ...
    if (myParam_X !== null){
        ...
        matSize_input.value = (Math.round(myParam * 10) / 10);
