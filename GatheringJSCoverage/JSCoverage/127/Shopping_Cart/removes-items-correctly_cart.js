...
function createCartElement(cartItem, cartItemData, cartIndex) {
  ...
  cartItemRemoveButton.addEventListener("click", () => {removeItem(cartIndex)}, false);
...
function removeItem(cartObjectIndex) {
  //remove HTML Element
  document.getElementById("cart-item-" + cartObjectIndex).remove();
  //remove from localStorage
  Cart.removeByIndex(cartObjectIndex);
  //retrieve new Cart again
  cartObjects = Cart.retrieve();
