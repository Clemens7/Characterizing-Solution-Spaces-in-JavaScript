...
export class FrameConfig {
    ...
    constructor(printSize=printSizeDefault, 
        ...
        if(printSize !== null && printSizeValues.includes(printSize)) {
        ...
        if(frameWidth !== null) {
            ...
            if(frameWidthValues.includes(Number(frameWidth))) {
                this.frameWidth = Number(frameWidth);
            }
        }

        if(frameStyle !== null && frameStyleValues.includes(frameStyle)) {
        ...
        if(matWidth !== null) {
            ...
            if(matWidthValues.includes(Number(matWidth))) {
                this.matWidth = Number(matWidth);
            }
        }

        if(matColor !== null && matColorValues.includes(matColor)) {
