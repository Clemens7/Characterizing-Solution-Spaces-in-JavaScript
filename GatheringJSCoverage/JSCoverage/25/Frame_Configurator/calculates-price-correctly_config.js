...
function getCheckedSize() {
    if (document.getElementById("print-size-s").checked === true) return "S";
...
function getCheckedColor() {
    if (document.getElementById("mat-color-coal").checked === true) return "coal";
    else if (document.getElementById("mat-color-indigo").checked === true) 
    else if (document.getElementById("mat-color-ivory").checked === true) return "ivory";
    else if (document.getElementById("mat-color-mint").checked === true) return "mint";
    else return "wine";
}
...
function getCheckedStyle() {
    if (document.getElementById("frame-style-classic").checked === true) return "classic";
    else if (document.getElementById("frame-style-shabby").checked === true) return "shabby";
    else if (document.getElementById("frame-style-elegant").checked === true) return "elegant";
    else return "natural";
 ...
 */
function frameW_input_write_slider() {
    if (this.value.length !== 0) {
        if (this.value < 2) 
        if (this.value > 5) 
        if (this.value.length > 3) 
        document.getElementById("frameWidth-slider").setAttribute('value', this.value);
    }
}
