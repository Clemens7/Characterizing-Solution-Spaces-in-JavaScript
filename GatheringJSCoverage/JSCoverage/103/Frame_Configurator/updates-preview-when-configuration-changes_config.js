...
async function onLoad() {
    ...
    form.frameWidth.onchange = form.frameWidthR.onchange = (event) => {
        form.frameWidthR.value = clamp(event.target.value,2,5);
        form.frameWidth.value = form.frameWidthR.value;
    }
