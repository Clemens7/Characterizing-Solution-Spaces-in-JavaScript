...
printSizeItems.forEach(e => e.addEventListener('change', e => changeTriggered()));
let frameStyleItems = document.getElementsByName(FRAME_STYLE_LITERAL);
frameStyleItems.forEach(e => e.addEventListener('change', e => changeTriggered()));
let matColorItems = document.getElementsByName(MAT_COLOR_LITERAL);
matColorItems.forEach(e => e.addEventListener('change', e => changeTriggered()));
document.getElementById(MAT_WIDTH_LITERAL).addEventListener('change', e => changeTriggered());
