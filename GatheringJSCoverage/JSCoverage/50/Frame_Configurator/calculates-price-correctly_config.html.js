    ...
    //Changing the settings
      ...
      document.getElementsByName('frameStyle')[0].addEventListener('click', event => {
          frameStyle = document.getElementsByName('frameStyle')[0].value;
      })
      ...
      document.getElementsByName('matColor')[0].addEventListener('click', event => {
          matColor = document.getElementsByName('matColor')[0].value;
      })
