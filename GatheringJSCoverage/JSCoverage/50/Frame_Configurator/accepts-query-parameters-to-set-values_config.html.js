    ...
    document.addEventListener('DOMContentLoaded', event =>{
        ...
        if(window.location.search.split('printSize=')[1]===undefined) 
            ...
            if(window.location.search.split('printSize=')[1].indexOf('&')===-1) 
            else printSize = printSize.substring(0,window.location.search.split('printSize=')[1].indexOf('&'));
        }
        ...
        if(frameStyle===undefined) 
            ...
            if(window.location.search.split('frameStyle=')[1].indexOf('&')===-1) 
            else frameStyle = frameStyle.substring(0,window.location.search.split('frameStyle=')[1].indexOf('&'));
        }
        ...
        if(window.location.search.split('frameWidth=')[1]===undefined) 
            ...
            if(window.location.search.split('frameWidth=')[1].indexOf('&')===-1) 
            else frameWidth= parseFloat(frameWidth.substring(0,window.location.search.split('frameWidth=')[1].indexOf('&')))/10;
        }
        ...
        if(matColor===undefined) 
            ...
            if(window.location.search.split('matColor=')[1].indexOf('&')===-1) matColor = window.location.search.split('matColor=')[1];
        }
        ...
        if(window.location.search.split('matWidth=')[1]===undefined) 
            ...
            if(window.location.search.split('matWidth=')[1].indexOf('&')===-1) 
            else matWidth= parseFloat(matWidth.substring(0,window.location.search.split('matWidth=')[1].indexOf('&')))/10;
        }
        ...
        switch(frameStyle) {
            ...
            case 'shabby':
                document.getElementById('frame-style-shabby').click();
                break;
    ...
    //Changing the settings
      ...
      document.getElementsByName('frameStyle')[1].addEventListener('click', )
