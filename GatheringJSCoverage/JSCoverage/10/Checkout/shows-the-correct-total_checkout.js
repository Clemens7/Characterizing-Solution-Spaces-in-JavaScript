...
select.addEventListener("change", function total(event) {
    const options = select.options;
    const shippingCost = (options[options.selectedIndex].id) / 100;
    fillPrices(shippingCost, "price-shipping");
    fillPrices(shippingCost + subtotal, "price-total");
