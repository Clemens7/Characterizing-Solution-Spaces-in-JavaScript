    ...
    function updateValue(target) {
      if (target.id.startsWith("print-size-"))else if (target.id.startsWith("frameWidth")){
    ...
    function setFrameWidth(frameWidth) {
      if (frameWidth < 2){
        setBothFrameWidths(2)
        console.log(`Wrong Frame Width: ${frameWidth} (only between 2 and 5 cm)`)
        return;
      }
      if (frameWidth > 5){
        setBothFrameWidths(5)
        console.log(`Wrong Frame Width: ${frameWidth} (only between 2 and 5 cm)`)
        return
      }
