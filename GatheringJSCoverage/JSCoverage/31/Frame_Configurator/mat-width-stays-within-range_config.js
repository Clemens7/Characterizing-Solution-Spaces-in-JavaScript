...
matWidthNumber.onchange = () => {
    ...
    if (matWidthNumber === 0 || matWidthNumber.value) {        
        ...
        if (value < parseFloat(matWidthNumber.min)) {
            matWidthNumber.value = matWidthNumber.min
        } else if (value > parseFloat(matWidthNumber.max)) {
            matWidthNumber.value = matWidthNumber.max
        }
