...
frameWidthNumber.onchange = () => {
    ...
    if (frameWidthNumber.value) {        
        ...
        if (value < parseFloat(frameWidthNumber.min)) {
            frameWidthNumber.value = frameWidthNumber.min
        } else if (value > parseFloat(frameWidthNumber.max)) {
            frameWidthNumber.value = frameWidthNumber.max
        }
