...
document.getElementsByName('matWidth')[0].addEventListener('change', function(){
    this.value = this.valueAsNumber.toFixed(1);
...
document.getElementsByClassName('segmented')[0].addEventListener('click', function(){ render();})

document.getElementsByClassName('mat-color-row')[0].addEventListener('click', function(){ render();})
