function  refreshConfig() {
    ...
    document.getElementById("frame-style-natural").onchange = function () {
        updateConfig();
    };

    document.getElementById("frame-style-elegant").onchange = function () {
        updateConfig();
    };

    document.getElementById("frame-style-shabby").onchange = function () {
        updateConfig();
    };

    document.getElementById("frame-style-classic").onchange = function () {
        updateConfig();
    };

    document.getElementById("mat-color-indigo").onchange = ;

    document.getElementById("mat-color-ivory").onchange = function () {
        updateConfig();
    };

    document.getElementById("mat-color-mint").onchange = ;

    document.getElementById("mat-color-wine").onchange = function () {
        updateConfig();
    };

    document.getElementById("mat-color-coal").onchange = function () {
        updateConfig();
    };

    document.getElementById("print-size-s").onchange = function () {
        updateConfig();
    };


    document.getElementById("print-size-m").onchange = function () {
        updateConfig();
    };

    document.getElementById("print-size-l").onchange = function () {
        updateConfig();
    };
