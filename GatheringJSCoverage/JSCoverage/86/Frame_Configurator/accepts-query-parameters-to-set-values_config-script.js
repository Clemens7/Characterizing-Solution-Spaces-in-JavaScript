...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (params.get('printSize')) printSize = params.get('printSize');
  if (params.get('frameStyle')) frameStyle = params.get('frameStyle');
  if (params.get('frameWidth')) frameWidth = params.get('frameWidth')/10;
  if (params.get('matColor')) matColor = params.get('matColor');
  if (params.get('matWidth')) matWidth = params.get('matWidth')/10;
