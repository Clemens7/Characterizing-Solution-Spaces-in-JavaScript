...
function getPrintSize() {
    if (print_size_s.checked) {
        return print_size_s.value;
        //return "S";
    } else if (print_size_m.checked) {
        return print_size_m.value;
        //return "M";
    } else if (print_size_l.checked) {
        return print_size_l.value;
        //return "L";
    }
}

function getFrame() {
    if (frame_style_classic.checked) {
        return "classic"
    } else if (frame_style_natural.checked) {
        return "natural";
    } else if (frame_style_shabby.checked) {
        return "shabby";
    } else if (frame_style_elegant.checked) {
        return "elegant";
    }
...
function getMat() {
    if (mat_color_ivory.checked) {
        return 'ivory';
    } else if (mat_color_mint.checked) {
        return 'mint';
    } else if (mat_color_wine.checked) {
        return 'wine';
    } else if (mat_color_indigo.checked)  else if (mat_color_coal.checked) {
        return 'coal';
    }
}

function roundFrame(frame) {
    let number = parseFloat(frame);
    if (number <= 2) 
    if (number >= 5) {
        number = 5;
    }
...
function frameRangeValue (frame) {
    let newValue = roundFrame(frame.value);

    let target = document.getElementById('frameWidth');
    target.value = newValue;
    let target2 = document.getElementById('frameWidthR');
    target2.value = newValue;
}

function roundMat(mat) {
    let number = parseFloat(mat);
    if (number <= 0) {
        number = 0;
    }
    if (number >= 10) 
...
function matRangeValue (mat) {
    let newValue = roundMat(mat.value);
    let target = document.getElementById('matWidth');
    target.value = newValue;
    let target2 = document.getElementById('matWidthR');
    target2.value = newValue;
}
