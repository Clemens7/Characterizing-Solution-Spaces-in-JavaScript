    ...
    document.getElementById("frame-style-classic").addEventListener('click', event => configUtil.onRadioFormChange(event.target));
    document.getElementById("frame-style-natural").addEventListener('click', event => configUtil.onRadioFormChange(event.target));
    ...
    document.getElementById("mat-color-ivory").addEventListener('click', event => configUtil.onRadioFormChange(event.target));
