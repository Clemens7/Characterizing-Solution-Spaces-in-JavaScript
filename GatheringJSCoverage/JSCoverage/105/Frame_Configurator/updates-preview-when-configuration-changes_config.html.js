  ...
  allMatColors[1].addEventListener('change', function(){
    matColor = allMatColors[1].value;
    updateFrame();
  });
  ...
  allMatColors[3].addEventListener('change', function(){
    matColor = allMatColors[3].value;
    updateFrame();
  });
