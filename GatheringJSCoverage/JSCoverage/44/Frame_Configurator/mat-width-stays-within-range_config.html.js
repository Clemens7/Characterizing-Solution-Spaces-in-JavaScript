...
/////////////////////////////////////////////////////////////////////////
    ...
    matText[0].addEventListener('change', event => {
      matWidth = matText[0].value;
      let y = document.getElementsByName('matWidthR');
      if (matWidth < 0){
        matWidth = 0;
      }else if (matWidth > 10) {
        matWidth = 10;
      }
      y[0].value = Math.round(matWidth * 10) / 10;
      matText[0].value = Math.round(matWidth * 10) / 10;
    });
