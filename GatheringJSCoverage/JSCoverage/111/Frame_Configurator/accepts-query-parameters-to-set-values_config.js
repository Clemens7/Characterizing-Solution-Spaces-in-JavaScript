...
loadCartLink();
if (printSize) {
    let printSizeOption = document.getElementById('print-size-' + printSize.toLowerCase());
    if (printSizeOption) {
        printSizeOption.checked = true;
    }
}
if (frameStyle) {
    let frameStyleOption = document.getElementById('frame-style-' + frameStyle.toLowerCase());
    if (frameStyleOption) {
        frameStyleOption.checked = true;
    }
}
...
if (matColor) {
    let matColorOption = document.getElementById('mat-color-' + matColor.toLowerCase());
    if (matColorOption) {
        matColorOption.checked = true;
    }
}
...
// event listener
frameWidthInput.addEventListener("keypress", );

frameWidthInput.addEventListener("focusout", );
