...
function displayCart(artWorks, quantity){
    ...
    if(quantity){
        ...
        artWorks.forEach((item, index)=> {
        document.getElementsByClassName('cart-remove')[index].addEventListener('click', function (event) {
        let buttonClicked = event.target
        buttonClicked.parentElement.parentElement.remove()
        removeCartItems(item.objectID);//attribute für objectid
