 ...
 */
printSizeRadios.forEach(radio => radio.addEventListener('change', () => printSizeChange(radio.value)));
 ...
 */
function printSizeChange(newValue) {
    printSizeQuery = newValue;
    setTotalSize();
    setPrice();
    renderPreview();
}
 ...
 */
frameStyleRadios.forEach(radio => radio.addEventListener('change', () => frameStyleChange(radio.value)));
 ...
 * @param newValue Changed value of radio button group.
 */
function frameStyleChange(newValue) {
    frameStyleQuery = newValue;
    setPrice();
    renderPreview();
}
 ...
 */
matColorRadios.forEach(radio => radio.addEventListener('change', () => matColorChange(radio.value)));
 ...
 * @param newValue Changed value of radio button group.
 */
function matColorChange(newValue) {
    matColorQuery = newValue;
    renderPreview();
}
