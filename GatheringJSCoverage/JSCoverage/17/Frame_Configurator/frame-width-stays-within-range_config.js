...
document.getElementById("frame-width-text").addEventListener("change", function (e) {
    updateValue(e.target.value, ["frame-width-slider", "frame-width-text"], 2, 5);
    updatePage();
});
...
document.getElementById("frame-width-text").addEventListener("blur", function (e) {
    if (e.target.value === "") 
});
