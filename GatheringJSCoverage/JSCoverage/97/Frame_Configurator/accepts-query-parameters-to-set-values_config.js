...
document.addEventListener('DOMContentLoaded', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!objectID) 
        ...
        id = params.get("id");
        printSizeValue = (_a = params.get('printSize')) !== null && _a !== void 0 ? _a ;
        frameStyleValue = (_b = params.get('frameStyle')) !== null && _b !== void 0 ? _b ;
        frameWidthValue = mmToCm(Math.max(20, Math.min(50, (_c = Number(params.get('frameWidth'))) !== null && _c !== void 0 ? _c )));
        matColorValue = (_d = params.get('matColor')) !== null && _d !== void 0 ? _d ;
        matWidthValue = mmToCm(Math.max(0, Math.min(100, Number((_e = params.get('matWidth')) !== null && _e !== void 0 ? _e ))));
