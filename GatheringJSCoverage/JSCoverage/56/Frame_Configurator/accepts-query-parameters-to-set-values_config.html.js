        ...
        function setFrameParameters(printSize, frameWidth, frameStyle, matWidth, matColor) {
            if (printSize) {
                currentItem.printSize = Config.setRadioParameter('printSize', printSize);
            }
            if (frameStyle) {
                currentItem.frameStyle = Config.setRadioParameter('frameStyle', frameStyle);
            }
            if (matColor) {
                currentItem.matColor = Config.setRadioParameter('matColor', matColor);
            }
            if (frameWidth) {
                currentItem.frameWidth = Config.setFrameWidth(frameWidth / 10);
            }
            if (matWidth) {
                currentItem.matWidth = Config.setMatWidth(matWidth / 10);
            }
        }
