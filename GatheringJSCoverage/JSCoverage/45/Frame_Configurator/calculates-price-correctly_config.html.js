    ...
    function changePrintSize(event) {
      printSize = event.target.value;
      renderImage();
      calculateTotalPrice();
    }
    function changeFrameWidth(event) {
      frameWidth = event.target.value * 10;
      renderImage();
      calculateTotalPrice();
    }
    function changeFrameStyle(event) {
