...
class Config {
    ...
    constructor() {
        ...
        new RangeNumberInput('frameWidthNumberInput', 'frameWidthRangeInput', (frameWidth) => { this._frameWidth = frameWidth * 10; this.updateFrame(); this.updateTotalSize(); this.updatePrice(); }, this._frameWidth / 10, (value) => value < 2 ? 2 : (value > 5 ? 5 : Math.round(parseFloat(value) * 10) / 10));
