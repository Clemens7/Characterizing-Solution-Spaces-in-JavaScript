...
class Config {
    ...
    constructor() {
        ...
        this._printSize = searchParams.get('printSize') !== null ? searchParams.get('printSize') ;
        this._frameWidth = searchParams.get('frameWidth') !== null ? searchParams.get('frameWidth') ;
        this._frameStyle = searchParams.get('frameStyle') !== null ? searchParams.get('frameStyle') ;
        this._matWidth = searchParams.get('matWidth') !== null ? searchParams.get('matWidth') ;
        this._matColor = searchParams.get('matColor') !== null ? searchParams.get('matColor') ;
