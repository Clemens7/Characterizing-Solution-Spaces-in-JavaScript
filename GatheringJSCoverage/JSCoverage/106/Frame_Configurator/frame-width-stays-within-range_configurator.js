...
window.onload = async function () {
  ...
  this.document
    ...
    .addEventListener('change', function () {
      ...
      if (value < 2) document.getElementsByName('frameWidth')[0].value = 2;
      else if (value > 5) document.getElementsByName('frameWidth')[0].value = 5;
      else document.getElementsByName('frameWidth')[0].value = value;
      document.getElementsByName(
        'frameWidthR'
      )[0].value = document.getElementsByName('frameWidth')[0].value;
      updatePrice();
      renderImg();
    });
