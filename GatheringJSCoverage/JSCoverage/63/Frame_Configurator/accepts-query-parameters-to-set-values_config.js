...
export class Config {
    ...
    set printSize(value) {
        this._printSize = parseString(value, /^[SML]$/) ;
    }

    set frameStyle(value) {
        this._frameStyle = parseString(value, /^(classic|natural|shabby|elegant)$/) ;
    }
    ...
    set matColor(value) {
        this._matColor = parseString(value, /^(ivory|mint|wine|indigo|coal)$/) ;
    }
