    ...
    document.getElementById("matwidthnumber").addEventListener("change", function(){
      if(document.getElementById("matwidthnumber").value < 0){
        document.getElementById("matwidthnumber").value = 0;
      }else if(document.getElementById("matwidthnumber").value > 10){
        document.getElementById("matwidthnumber").value = 10;
      }
