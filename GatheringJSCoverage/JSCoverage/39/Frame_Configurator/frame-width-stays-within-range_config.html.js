    ...
    document.getElementById("framewidthnumber").addEventListener("change", function(){
      if(document.getElementById("framewidthnumber").value < 2){
        document.getElementById("framewidthnumber").value = 2;
      }else if(document.getElementById("framewidthnumber").value > 5){
        document.getElementById("framewidthnumber").value = 5;
      }
