    ...
    document.getElementById("matwidthnumber").addEventListener("change", function(){
      if(document.getElementById("matwidthnumber").value < 0)else if(document.getElementById("matwidthnumber").value > 10)

      document.getElementById("matwidthnumber").value = Math.round(document.getElementById("matwidthnumber").value*10)/10;

      document.getElementById("matwidthrange").value = document.getElementById("matwidthnumber").value;
    ...
    document.getElementById("matcolor").addEventListener("change", function () {
      renderPictureAndPriceAndSize();
    })
    ...
    function renderPictureAndPriceAndSize() {
      ...
      if(document.querySelector('input[name="printSize"]:checked').value === 'S'){
        totalwidth = sizes.S[0]/10;
        totalheight = sizes.S[1]/10;
      }else if(document.querySelector('input[name="printSize"]:checked').value === 'M'){
        totalwidth = sizes.M[0]/10;
        totalheight = sizes.M[1]/10;
      }else if(document.querySelector('input[name="printSize"]:checked').value === 'L'){
        totalwidth = sizes.L[0]/10;
        totalheight = sizes.L[1]/10;
      }
