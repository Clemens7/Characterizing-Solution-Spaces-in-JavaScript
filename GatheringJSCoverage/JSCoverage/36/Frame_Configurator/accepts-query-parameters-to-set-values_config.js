...
printSize = params.get('printSize') ? params.get('printSize') ;
frameStyle = params.get('frameStyle') ? params.get('frameStyle') ;
frameWidth = params.get('frameWidth') ? Number(params.get('frameWidth')) ;
matColor = params.get('matColor') ? params.get('matColor') ;
matWidth = params.get('matWidth') ? Number(params.get('matWidth')) ;
