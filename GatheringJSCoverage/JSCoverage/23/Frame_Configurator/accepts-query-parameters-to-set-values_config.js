...
let printSize = urlParams.get('printSize') === null || undefined  : urlParams.get('printSize');
let frameStyle = urlParams.get('frameStyle') === null || undefined  : urlParams.get('frameStyle');
let matColor = urlParams.get('matColor') === null || undefined  : urlParams.get('matColor');
let matWidth = urlParams.get('matWidth') === null || undefined  : urlParams.get('matWidth')/10;
let frameWidth = urlParams.get('frameWidth') === null || undefined  : urlParams.get('frameWidth')/10;
