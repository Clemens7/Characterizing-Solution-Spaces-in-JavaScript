    ...
    printSizeRadios.forEach(radio => radio.addEventListener('click', function() {
    ...
    matWidthInput.addEventListener('change', function() {
      this.value = round(clamp(this.value, 0, 10));
      matWidthSlider.value = this.value;
    ...
    matColorRadios.forEach(radio => radio.addEventListener('click', function() {
      matColor = this.value;
      renderFrame();
    }));
