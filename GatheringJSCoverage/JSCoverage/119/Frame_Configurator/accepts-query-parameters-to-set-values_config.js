...
function InitWithQueryParamsTest() {

    console.log("---------Test---------")

    frameWidth = document.querySelector("input[name='frameWidth']");
    frameWidth.value = urlParams.get("frameWidth") / 10;

    matWidth = document.querySelector("input[name='matWidth']");
    matWidth.value = urlParams.get("matWidth") / 10;

    printSize = document.querySelector("input[id=print-size-" + urlParams.get("printSize").toLowerCase() + "]");
    printSize.checked = true;
    console.log(printSize);

    frameStyle = document.querySelector("input[id=frame-style-" + urlParams.get("frameStyle").toLowerCase() + "]");
    frameStyle.checked = true;
    console.log(frameStyle);

    matColor = document.querySelector("input[id=mat-color-" + urlParams.get("matColor").toLowerCase() + "]");
