...
function updateInputs() {
    if(selectedPrintSize != null) {
        document.querySelector('#config-form').printSize.value = selectedPrintSize;
    }
    if(frameWidth != null) {
        document.querySelector('#config-form').frameWidth.value = frameWidth /10;
    }

    if(matColor != null) {
        document.querySelector('#config-form').matColor.value = matColor;
    }

    if(matWidth != null) {
        document.querySelector('#config-form').matWidth.value = matWidth /10;
    }
	
	if(frameStyle != null) {
        document.querySelector('#config-form').frameStyle.value = frameStyle;
    }
