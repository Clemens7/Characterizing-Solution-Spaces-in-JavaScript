...
export function calculatePrice(printSize, frameStyle, frameWidth, matWidth) {
	...
	price =price+30;
	if(printSize == "S" || printSize == "s")else if(printSize == "M" || printSize == "m")else if(printSize == "L" ){
		return price * 3.5;
	}}


function costsOfFrameStylePerCM(frameStyle){
	if(frameStyle == "Classic" || frameStyle == "classic") else if(frameStyle == "Natural" || frameStyle == "natural") else if(frameStyle == "Shabby" || frameStyle == "shabby"){
		return 0.90;
	}
}
