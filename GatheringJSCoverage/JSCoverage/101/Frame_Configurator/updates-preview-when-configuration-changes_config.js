...
function updateRenderer() {
    ...
    document.getElementById('total-size').innerText = `${Math.round(((printSizeInput.value=="S"?29.7:printSizeInput.value=="M"?42:printSizeInput.value=="L"?59.4)+frameWidthInput.value*2+matWidthInput.value*2)*10)/10} × ${Math.round(((printSizeInput.value=="S"?20.2:printSizeInput.value=="M"?28.7:printSizeInput.value=="L"?40.5)+frameWidthInput.value*2+matWidthInput.value*2)*10)/10} cm`;
}
...
document.getElementById('frameWidth').addEventListener("change", function() {
    this.value = Math.round(this.value * 10) / 10;
    if (this.value < 2)  else if (this.value > 5) 
    document.getElementById('frameWidthR').value = this.value;
    updateRenderer();
...
document.getElementById('matWidth').addEventListener("change", function() {
    this.value = Math.round(this.value * 10) / 10;
    if (this.value < 0)  else if (this.value > 10) 
