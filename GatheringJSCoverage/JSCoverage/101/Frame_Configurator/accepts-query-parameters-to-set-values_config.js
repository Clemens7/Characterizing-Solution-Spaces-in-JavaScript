...
if (frameWidth != null) {
    let frameWidthDOM = document.getElementById("frameWidth");
    let frameWidthRDOM = document.getElementById("frameWidthR");
    frameWidthRDOM.value = frameWidth / 10;
    frameWidthDOM.value = frameWidth / 10;
    if (frameWidth / 10 < 2)  else if (frameWidth / 10 > 5) 
}
...
if (matWidth != null) {
    let matWidthDOM = document.getElementById("matWidth");
    let matWidthRDOM = document.getElementById("matWidthR");
    matWidthRDOM.value = matWidth / 10;
    matWidthDOM.value = matWidth / 10;
    if (matWidth / 10 < matWidthRDOM.min)  else if (matWidth / 10 > matWidthRDOM.max) 
}
