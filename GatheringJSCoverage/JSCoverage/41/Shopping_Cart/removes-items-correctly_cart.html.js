    ...
    function removeItemFromCartAndLoad(index) {
      CartCache.deleteObj(index);
      retrieveCart();
    }
    ...
    async function retrieveCart() {
      ...
      for (let item of items) {
        ...
        document.getElementById("" + i).addEventListener("click", function () { removeItemFromCartAndLoad(this.id) });
