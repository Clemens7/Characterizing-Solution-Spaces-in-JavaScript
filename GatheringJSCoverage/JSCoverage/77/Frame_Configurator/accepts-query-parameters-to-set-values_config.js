...
function getArtworkConfigFromUrl(artwork) {
    ...
    if (printSize !== null) artwork.printSize = printSize;
    if (frameStyle !== null) artwork.frameStyle = frameStyle;
    if (frameWidth !== null) artwork.frameWidth = frameWidth;
    if (matColor !== null) artwork.matColor = matColor;
    if (matWidth !== null) artwork.matWidth = matWidth;
