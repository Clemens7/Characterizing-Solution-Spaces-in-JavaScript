...
class FrameConfigurator {
    ...
    initOnChangeListeners() {
        ...
        this.frameWidthTextElement.addEventListener('change', (event) => {
            this.onChangeFrameWidth(event);
        });
        ...
        frameStyleRadios.forEach((radio) => {
            radio.addEventListener('change', (e) => {
                this.frameStyle = e.target.value;
                this.updateFramePreview();
            });
        });
    }
    onChangeFrameWidth(event) {
        this.frameWidth = Number.parseFloat(event.target.value);
        this.validateFrameWidth();
        this.frameWidthTextElement.value = this.frameWidth.toString();
        this.frameWidthSliderElement.value = this.frameWidth.toString();
        this.updateFramePreview();
    }
