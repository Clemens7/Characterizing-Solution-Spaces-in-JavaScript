...
(async () => {
    ...
    printSize.value = printSizeParam ? printSizeParam ;
    frameStyle.value = frameStyleParam ? frameStyleParam ;
    frameWidth.value = frameWidthParam ? frameWidthParam / 10 ;
    matColor.value = matColorParam ? matColorParam ;
    matWidth.value = matWidthParam ? matWidthParam / 10 ;
