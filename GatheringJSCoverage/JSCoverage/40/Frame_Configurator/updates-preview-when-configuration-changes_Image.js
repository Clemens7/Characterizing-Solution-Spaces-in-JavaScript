...
export class Image {
    ...
    set printSize(value) { this._printSize = value; this.renderImage() }

    set frameStyle(value) { this._frameStyle = value; this.renderImage() }

    set frameWidth(value) { this._frameWidth = value; this.renderImage() }

    set matColor(value) { this._matColor = value; this.renderImage() }
