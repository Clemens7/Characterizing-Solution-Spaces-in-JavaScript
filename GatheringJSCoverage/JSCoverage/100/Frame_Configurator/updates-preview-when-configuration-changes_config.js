...
frameWidthField.addEventListener('focusout', _ => {
    config.frameWidth = sanitize(frameWidthField.value, 2, 5)
...
matWidthField.addEventListener('focusout', _ => {
    config.matWidth = sanitize(matWidthField.value, 0, 10)
