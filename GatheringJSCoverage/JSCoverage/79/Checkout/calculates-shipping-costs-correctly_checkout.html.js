    ...
    async function selectedCountryChanged(){
      try{
        ...
        for(let i = 0; i < x.destinations.length; i++){
          if(selectedCountry === x.destinations[i].country){
            SHIPPING_COST = x.destinations[i].cost / 100;
