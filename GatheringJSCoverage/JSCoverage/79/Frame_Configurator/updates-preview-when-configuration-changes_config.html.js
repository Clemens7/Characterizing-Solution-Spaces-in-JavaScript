    ...
    function setParameteres(){
      ...
      if(s === true) printSize = 'S';
      if(m === true) printSize = 'M';
      if(l === true) printSize = 'L';
      ...
      if(classic === true) frameStyle = 'classic';
      if(natural === true) frameStyle = 'natural';
      if(shabby === true) frameStyle = 'shabby';
      if(elegant === true) frameStyle = 'elegant';
      ...
      if(ivory === true) matStyle = 'ivory';
      if(mint === true) matStyle = 'mint';
      if(wine === true) 
      if(indigo === true) matStyle = 'indigo';
      if(coal === true) matStyle = 'coal';
    ...
    function printTotal(){
      ...
      if(printSize === 'S'){
        totalSize.innerHTML = `${(sizeS[0] + frameWidth + matWidth)/10} x ${(sizeS[1] + frameWidth + matWidth)/10} cm`
      }
      if(printSize === 'M'){
        totalSize.innerHTML = `${(sizeM[0] + frameWidth + matWidth)/10} x ${(sizeM[1] + frameWidth + matWidth)/10} cm`
      }
      if(printSize === 'L'){
        totalSize.innerHTML = `${(sizeL[0] + frameWidth + matWidth)/10} x ${(sizeL[1] + frameWidth + matWidth)/10} cm`
      }
    }
